...
namespace Problem4
{
    public class StartUp
    {
        ...
        private static void AddMinionVillain(SqlConnection connection, int? villainId, 
            int minionId, string minionName, string villainName)
        {
        ...
        {
            string insertVillianSql = @"INSERT INTO Villains (Name, EvilnessFactorId)  VALUES (@villainName, 4)";

            using (SqlCommand command = new SqlCommand(insertVillianSql,connection))
            {
