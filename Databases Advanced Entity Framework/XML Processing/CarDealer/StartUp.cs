...
namespace CarDealer
{
    public class StartUp
    {
        ...
        private static void SeedData(CarDealerContext context)
        {
            ...
            xmlData = File.ReadAllText(@"..\..\..\Datasets\suppliers.xml");
            seedData = ImportSuppliers(context, xmlData);
            Console.WriteLine(seedData);

            xmlData = File.ReadAllText(@"..\..\..\Datasets\parts.xml");
            seedData = ImportParts(context, xmlData);
            Console.WriteLine(seedData);

            xmlData = File.ReadAllText(@"..\..\..\Datasets\cars.xml");
            seedData = ImportCars(context, xmlData);
            Console.WriteLine(seedData);

            xmlData = File.ReadAllText(@"..\..\..\Datasets\customers.xml");
            seedData = ImportCustomers(context, xmlData);
            Console.WriteLine(seedData);

            xmlData = File.ReadAllText(@"..\..\..\Datasets\sales.xml");
            seedData = ImportSales(context, xmlData);
            Console.WriteLine(seedData);
        }
    }
}