...
namespace CarDealer
{
    public class StartUp
    {
        ...
        {
            var carsData = JsonConvert.DeserializeObject<PartsCarDto[]>(inputJson).ToList();
        ...
        {
            var supplires = JsonConvert.DeserializeObject<Supplier[]>(inputJson).ToList();
        ...
        private static void Seed(CarDealerContext context)
        {
            ...
            jsonData = File.ReadAllText(@"..\..\..\Datasets\suppliers.json");
            seedData = ImportSuppliers(context, jsonData);
            Console.WriteLine(seedData);

            jsonData = File.ReadAllText(@"..\..\..\Datasets\parts.json");
            seedData = ImportParts(context, jsonData);
            Console.WriteLine(seedData);

            jsonData = File.ReadAllText(@"..\..\..\Datasets\cars.json");
            seedData = ImportCars(context, jsonData);
            Console.WriteLine(seedData);

            jsonData = File.ReadAllText(@"..\..\..\Datasets\customers.json");
            seedData = ImportCustomers(context, jsonData);
            Console.WriteLine(seedData);

            jsonData = File.ReadAllText(@"..\..\..\Datasets\sales.json");
            seedData = ImportSales(context, jsonData);
            Console.WriteLine(seedData);
        }
    }
}