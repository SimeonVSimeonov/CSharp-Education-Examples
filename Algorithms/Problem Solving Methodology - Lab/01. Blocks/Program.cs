...
namespace _01._Blocks
{
    class Program
    {
        ...
        private static HashSet<string> FindBlocks(int numberOfLetters)
        {
        ...
        private static void GenerateVariations(char[] letters, char[] currentCombination, bool[] used,
            HashSet<string> results, int index = 0)
        {
