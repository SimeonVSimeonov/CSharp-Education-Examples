...
public class CustomLinkedListTests
{
    ...
    [Test]
    public void GettingElementByIndexValidIndexSouldPass()
    {
    ...
    [TestCase("C#")]
    public void AddOneValidElementShouldPass(string value)
    {
    ...
    [TestCase("C#")]
    public void AddMutltipleElementsShouldPass(string value)
    {
        this.dynamicList.Add(value);
    ...
    [Test]
    public void RemoveExistringItemShouldPass()
    {
        var headField = FindFieldsViaReflection(headFieldName);
        var tailField = FindFieldsViaReflection(tailFieldName);
    ...
    [Test]
    public void RemoveNonExistingItemShouldReturnNegativeInteger()
    {
